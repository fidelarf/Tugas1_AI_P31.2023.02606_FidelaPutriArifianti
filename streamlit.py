...
with tab1 :
    ...
    restecg_sb = st.sidebar.selectbox(label=":violet[**Resting electrocardiographic result**]", options=["Normal", "having ST-T wave abnormality", "Showing lwft ventricular hypertrophy"])
    st.sidebar.write("")
    st.sidebar.write("")
